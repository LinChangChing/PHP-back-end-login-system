                    ...
                    <div id="content" class="content">
                    	<ul class="tabs"><!--內容為02A02.txt-->
                            <li><a href="#tab1">健康新知</a> </li>
                            <li><a href="#tab2">菸害防治</a></li>
                            <li><a href="#tab1">癌症防治</a> </li>
                            <li><a href="#tab2">慢性病防治</a></li>
                        </ul>
                     <div class="tab_container">
                    	<div id="tab1" class="tab_content"><!--內容為02A03.txt-->
                        	<h2>健康新知</h2>
                            <p>
<pre>
...
7. 減少看電視、打電玩等靜態生活的時間。
    民眾對運動如有疑問，可參考國民健康局肥胖防治網-「快樂動」(http://obesity.bhp.gov.tw)，亦可撥打免費市話健康體重管理電話諮詢服務，諮詢專線「0800-367-100（0800-瘦落去-要動動）」，也可利用國民健康局局網首頁或肥胖防治網問題諮詢專區的網路電話撥入功能，向客服人員諮詢關於運動、健康飲食及健康體重管理等相關疑問。
                    ...
                    <div id="tab2" class="tab_content"><!--內容為02A04.txt-->
                        	<h2>菸害防治</h2>
                            <p>
<pre>
 菸害防治法規
...
第三十三條　　本法所定罰則，除第二十五條規定由中央主管機關處罰外，由直轄市、縣（市）主管機關處罰之。
                    ...
                    <div id="tab3" class="tab_content"><!--內容為02A05.txt-->
                        	<h2>癌症防治</h2>
                            <p>
<pre>
 降低罹癌風險 建構健康生活型態
...
上稿日期：2010/1/20
                    ...
                    <div id="tab4" class="tab_content"><!--內容為02A06.txt-->
                        	<h2>慢性病防治</h2>
                            <p>
<pre>
長期憋尿 泌尿系統問題多 
                ...
                <script type="application/javascript">
                        $(function(){
                              ...
                              $('#content').each(function(){
                                  ...
                                  $($defaultLi.find('a').attr('href')).siblings().hide(); //藏其他li中a的href
